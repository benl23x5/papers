...
set title "MapMap benchmark"

set terminal pdf size 3,2.2
set output "data/mapmap/graph.pdf"
...
plot    'data/mapmap/graph.dat' using ($1*$1):($2)             \
                title "Stream fusion"     ls 2  lw 4 with linespoints, \
        'data/mapmap/graph.dat' using ($1*$1):($3)             \
                title "Flow fusion"  ls 10  lw 4 with linespoints, \
        'data/mapmap/graph.dat' using ($1*$1):($4)             \
