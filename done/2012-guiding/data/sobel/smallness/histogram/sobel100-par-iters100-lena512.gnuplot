...
set output "data/sobel/smallness/histogram/sobel100-par-iters100-lena512.tex"
...
plot 	'data/sobel/smallness/histogram/sobel100-par-iters100-lena512.hist' using ($1+5):($3) with boxes