...
--
data Matrix where
  PatternMatrix :: (Int,Int) -> Int -> [(Int32,Int32)]               -> Matrix
  IntMatrix     :: (Int,Int) -> Int -> [(Int32,Int32,Int)]           -> Matrix
  RealMatrix    :: (Int,Int) -> Int -> [(Int32,Int32,Float)]         -> Matrix
  ComplexMatrix :: (Int,Int) -> Int -> [(Int32,Int32,Complex Float)] -> Matrix
