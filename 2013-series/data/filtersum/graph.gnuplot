...
set title "FilterSum benchmark"

set terminal pdf size 3,2.2
set output "data/filtersum/graph.pdf"
...
plot    'data/filtersum/graph.dat' using ($1*$1):($2)             \
                title "Stream fusion"     ls 2  lw 4 with linespoints, \
        'data/filtersum/graph.dat' using ($1*$1):($3)             \
                title "Flow fusion"  ls 10  lw 4 with linespoints, \
        'data/filtersum/graph.dat' using ($1*$1):($4)             \
